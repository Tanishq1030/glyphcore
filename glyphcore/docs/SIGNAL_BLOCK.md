...
*(Domain-agnostic: applies to finance, infrastructure, AI/ML, security, health, product, etc.)*
...
The framework is domain-agnostic. It doesn't know or care what the numbers represent (values, latency, loss, threats, etc.). The host application provides meaning.
